...
#     """
#     Muestra los pares de mayor |correlación| y los pares por encima de un umbral.
#     X: DataFrame SOLO con features numéricas.
#     """
...
#     """
#     Calcula VIF de manera robusta:
#     - Elimina columnas constantes y duplicadas exactas.
#     - Agrega constante para OLS.
#     - Si aparecen NaN, hace fallback con mínimos cuadrados (SVD).
#     Devuelve (vif_df, X_usado).
#     """
